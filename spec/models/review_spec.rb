...
RSpec.describe Review, type: :model do
  ...
  describe 'class methods' do
    before :each do
      ...
      @review = create(:review, user: @user, order_item: @order_item, rating: 1)
      @review2 = create(:review, user: @user, order_item: @order_item2, rating: 2)
      @review3 = create(:review, user: @user2, order_item: @order_item3, rating: 3)
      @review4 = create(:review, user: @user2, order_item: @order_item4, rating: 5)
    end
